# Osiris Beta_2026.0.31

Private GitHub prerelease for continued installation and update testing.
...
Download `Osiris-Beta_2026.0.31-win-x64.zip` from the release assets, extract it
